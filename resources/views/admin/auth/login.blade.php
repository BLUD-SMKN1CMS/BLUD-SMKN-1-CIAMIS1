        ...
        * {
        ...
        body {
            ...
            background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),
                        url('{{ asset("assets/smkn1ciamiswallpaper.png") }}') center/cover no-repeat fixed;
            min-height: 100vh;
            display: flex;
            align-items: center;
...
<div class="login-container">
    ...
    <div class="login-header">
        <div class="logo-container">
            <img src="{{ asset('assets/iconsmea.png') }}" class="logo" alt="Logo BLUD">
        </div>
    ...
    <div class="login-form">
        ...
        <div class="copyright">
            © {{ date('Y') }} BLUD SMKN 1 CIAMIS. All rights reserved.
        </div>
