                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <form action="{{ route('admin.carousels.toggle-status', $carousel->id) }}" method="POST" class="dropdown-item p-0">
                                                    @csrf
                                                    <button type="submit" class="dropdown-item text-decoration-none w-100 text-start">
                                                        <i class="fas fa-{{ $carousel->status === 'active' ? 'eye-slash' : 'eye' }} me-2 text-{{ $carousel->status === 'active' ? 'secondary' : 'success' }}"></i>
                                            ...
                                            <li>
                                                <form action="{{ route('admin.carousels.destroy', $carousel->id) }}" method="POST" class="dropdown-item p-0">
                                                    @csrf @method('DELETE')
