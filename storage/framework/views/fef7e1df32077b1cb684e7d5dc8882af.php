        ...
        <div class="card-body">
            ...
            <?php else: ?>
                        ...
                        <tbody id="sortable">
                            ...
                            <tr data-id="<?php echo e($carousel->id); ?>">
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <div class="bg-light text-center py-2" style="width: 80px; height: 45px;">
                                ...
                                <td>
                                    <span class="badge bg-<?php echo e($carousel->status === 'active' ? 'success' : 'secondary'); ?>">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item" href="<?php echo e(route('admin.carousels.edit', $carousel->id)); ?>">
                                                    <i class="fas fa-edit me-2 text-warning"></i> Edit
                                                </a>
                                            </li>
                                            <li>
                                                <form action="<?php echo e(route('admin.carousels.toggle-status', $carousel->id)); ?>" method="POST" class="dropdown-item p-0">
                                                    <?php echo csrf_field(); ?>
                                                    <button type="submit" class="dropdown-item text-decoration-none w-100 text-start">
                                                        <i class="fas fa-<?php echo e($carousel->status === 'active' ? 'eye-slash' : 'eye'); ?> me-2 text-<?php echo e($carousel->status === 'active' ? 'secondary' : 'success'); ?>"></i>
                                            ...
                                            <li>
                                                <form action="<?php echo e(route('admin.carousels.destroy', $carousel->id)); ?>" method="POST" class="dropdown-item p-0">
                ...
                <div class="alert alert-info mt-3">
                    ...
                    <strong>Tips:</strong> Drag & drop baris untuk mengubah urutan carousel
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp_new\htdocs\tefa_smkn1_ciamis\resources\views/admin/carousels/index.blade.php ENDPATH**/ ?>