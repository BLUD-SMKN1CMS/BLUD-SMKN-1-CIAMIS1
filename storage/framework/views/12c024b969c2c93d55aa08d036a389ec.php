                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <div class="bg-light rounded d-flex align-items-center justify-content-center border" 
                                         ...
                                         title="Gambar tidak tersedia: <?php echo e(basename($imagePath ?? 'Tidak ada')); ?>">
                            ...
                            <td>
                                <?php if($product->tefa): ?>
                                    ...
                                    <small class="d-block text-muted"><?php echo e(Str::limit($product->tefa->name, 15)); ?></small>
                                <?php else: ?>
                                    <span class="text-muted">-</span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <strong class="text-primary">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></strong>
                            </td>
                            <td>
                                <span class="badge 
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li>
                                            ...
                                            <form action="<?php echo e(route('admin.products.destroy', $product->id)); ?>" 
                                                  method="POST" 
                                                  id="delete-form-<?php echo e($product->id); ?>"
                                                  onsubmit="return confirm('Hapus produk <?php echo e($product->name); ?>?')">
                                                <?php echo csrf_field(); ?> 
                                                <?php echo method_field('DELETE'); ?>
                                            </form>
                                            <button type="submit" 
                                                    form="delete-form-<?php echo e($product->id); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp_new\htdocs\tefa_smkn1_ciamis\resources\views/admin/products/index.blade.php ENDPATH**/ ?>