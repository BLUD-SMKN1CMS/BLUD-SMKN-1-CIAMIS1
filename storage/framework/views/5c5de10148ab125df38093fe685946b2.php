<?php $__env->startSection('title', 'Tambah TEFA Baru'); ?>
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.tefas.store')); ?>" method="POST" id="tefaForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                value="<?php echo e(old('name')); ?>" required placeholder="Contoh: Akuntansi Keuangan Lembaga">
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('code')); ?>" required placeholder="Contoh: AKL">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" rows="3" 
                        placeholder="Deskripsi singkat tentang jurusan TEFA ini..."><?php echo e(old('description')); ?></textarea>
                </div>
                ...
                <div class="row mb-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="icon" class="form-control" id="iconInput"
                                    value="<?php echo e(old('icon', 'fas fa-school')); ?>" 
                            ...
                            <div class="mt-2" id="iconPreview">
                                <div class="border rounded p-3 text-center">
                                    <i class="<?php echo e(old('icon', 'fas fa-school')); ?> fa-2x mb-2 text-primary"></i>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="order" class="form-control" value="<?php echo e(old('order', 0)); ?>" min="0" max="100">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" name="services_json" id="servicesJson" 
                                value='<?php echo e(old('services_json', '[]')); ?>'>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp_new\htdocs\tefa_smkn1_ciamis\resources\views/admin/tefas/create.blade.php ENDPATH**/ ?>