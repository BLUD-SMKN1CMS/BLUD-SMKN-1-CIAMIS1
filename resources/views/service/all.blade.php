...
<section class="hero-section py-5 position-relative overflow-hidden"
    style="background: #0992C2; min-height: 300px; display: flex; align-items: center;">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm hover-shadow transition-all" style="border-radius: 15px; overflow: hidden;">
                    ...
                    <div class="card-img-top position-relative" style="height: 200px; background: #0992C2; display: flex; align-items: center; justify-content: center;">
