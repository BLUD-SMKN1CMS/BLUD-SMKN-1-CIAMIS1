                    ...
                    <div class="col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="{{ $loop->index * 100 }}">
                        <a href="{{ route('tefa.show', $tefa->slug) }}" class="text-decoration-none">
                            <div class="tefa-card p-4 text-center h-100">
                                ...
                                <h4 class="fw-bold mb-2">{{ $tefa->name }}</h4>
                                <p class="text-muted small">{{ Str::limit($tefa->description, 80) }}</p>
                                <div class="mt-3">
                        ...
                        <div class="card border-0 shadow-sm h-100 service-card">
                            <div class="card-body text-center p-4">
                                <div class="service-icon-wrapper mb-3">
                                    <i class="fas fa-{{ $service->name == 'Air Minum' ? 'tint' : ($service->name == 'Gedung Serbaguna' ? 'building' : 'bus') }} fa-3x service-icon"></i>
                                </div>
