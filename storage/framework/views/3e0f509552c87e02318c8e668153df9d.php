<?php $__env->startSection('title', 'Layanan Kami - BLUD SMKN 1 CIAMIS'); ?>
...
<section class="hero-section py-5 position-relative overflow-hidden" 
    ...
    <div class="container position-relative z-index-1 text-center text-white">
        ...
        <div class="search-box mx-auto" style="max-width: 600px;">
            <form action="<?php echo e(route('services.all')); ?>" method="GET" class="position-relative">
                <input type="text" name="search" class="form-control form-control-lg rounded-pill ps-4 pe-5 border-0 shadow-lg" 
                    placeholder="Cari layanan yang Anda butuhkan..." value="<?php echo e(request('search')); ?>"
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 bg-transparent p-0">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>" class="text-decoration-none">Beranda</a></li>
            ...
            <?php if(request('search')): ?>
                <div class="text-muted">
                    ...
                    <a href="<?php echo e(route('services.all')); ?>" class="text-danger ms-2 text-decoration-none small">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card h-100 border-0 shadow-sm hover-shadow transition-all" style="border-radius: 15px; overflow: hidden;">
                            ...
                            <div class="card-img-top position-relative" style="height: 200px; background: linear-gradient(135deg, #e0eafc 0%, #cfdef3 100%); display: flex; align-items: center; justify-content: center;">
                                <?php if($service->image && file_exists(public_path('storage/' . $service->image))): ?>
                                    <img src="<?php echo e(asset('storage/' . $service->image)); ?>" alt="<?php echo e($service->name); ?>" class="w-100 h-100 object-fit-cover">
                                <?php else: ?>
                                    <div class="text-center text-primary opacity-75">
                                        <i class="fas fa-<?php echo e($service->unit == 'orang' ? 'users' : ($service->unit == 'bus' ? 'bus' : ($service->unit == 'lab' ? 'laptop' : 'box'))); ?> fa-4x mb-3"></i>
                                    </div>
                                <?php endif; ?>
                            ...
                            <div class="card-body p-4 d-flex flex-column">
                                <h5 class="card-title fw-bold mb-2 text-dark"><?php echo e($service->name); ?></h5>
                                ...
                                <div class="pricing-info mb-4 bg-light rounded p-3">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <span class="fw-bold text-primary"><?php echo e($service->price_per_hour > 0 ? 'Rp ' . number_format($service->price_per_hour, 0, ',', '.') : '-'); ?></span>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <small class="text-muted"><i class="fas fa-calendar-day me-1"></i> Per Hari</small>
                                        <span class="fw-bold text-success"><?php echo e($service->price_per_day > 0 ? 'Rp ' . number_format($service->price_per_day, 0, ',', '.') : '-'); ?></span>
                                    </div>
                                </div>
                                
                                <a href="<?php echo e(route('service.show', $service->slug)); ?>" class="btn btn-outline-primary w-100 rounded-pill py-2 fw-bold">
        ...
        <?php else: ?>
            <div class="text-center py-5">
                ...
                <a href="<?php echo e(route('services.all')); ?>" class="btn btn-primary mt-3 rounded-pill px-4">
...
<section class="cta-section py-5 bg-white border-top">
    <div class="container text-center">
        ...
        <div class="d-flex justify-content-center gap-3 flex-wrap">
            <a href="https://wa.me/<?php echo e($contactInfo['whatsapp_number'] ?? '6281234567890'); ?>" target="_blank" class="btn btn-success btn-lg rounded-pill px-4 shadow-sm">
                <i class="fab fa-whatsapp me-2"></i> Chat WhatsApp
            </a>
            <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline-primary btn-lg rounded-pill px-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\BLUD-SMKN-1-CIAMIS\resources\views/service/all.blade.php ENDPATH**/ ?>