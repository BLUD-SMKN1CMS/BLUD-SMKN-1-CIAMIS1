<?php $__env->startSection('title', $service->name . ' - BLUD SMKN 1 CIAMIS'); ?>
            ...
            <div class="col-lg-8">
                <nav aria-label="breadcrumb" class="mb-4">
                    <ol class="breadcrumb" style="background: rgba(255,255,255,0.1); backdrop-filter: blur(10px); border-radius: 50px; padding: 12px 24px;">
                        <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>" style="color: white; text-decoration: none;">Beranda</a></li>
                        <li class="breadcrumb-item"><a href="<?php echo e(route('services.all')); ?>" style="color: white; text-decoration: none;">Layanan</a></li>
                        <li class="breadcrumb-item active" style="color: rgba(255,255,255,0.8);"><?php echo e($service->name); ?></li>
                    </ol>
                </nav>
            ...
            <div class="col-lg-4 text-center mt-4 mt-lg-0">
                <div class="service-badge" style="background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); border-radius: 20px; padding: 30px; border: 2px solid rgba(255,255,255,0.2);">
                    <div class="badge-icon mb-3" style="font-size: 4rem;">
                        <i class="fas fa-<?php echo e($service->unit == 'orang' ? 'users' : ($service->unit == 'bus' ? 'bus' : ($service->unit == 'lab' ? 'laptop' : 'box'))); ?>" style="color: white; filter: drop-shadow(0 4px 10px rgba(0,0,0,0.2));"></i>
                    </div>
                    <h3 class="text-white mb-2">Kapasitas</h3>
                    <p class="h2 text-white fw-bold mb-0"><?php echo e($service->capacity); ?> <?php echo e(ucfirst($service->unit)); ?></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="info-card" style="background: white; border-radius: 15px; padding: 30px; box-shadow: 0 10px 40px rgba(0,0,0,0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;" onmouseover="this.style.transform='translateY(-10px)'; this.style.boxShadow='0 15px 50px rgba(0,0,0,0.15)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 10px 40px rgba(0,0,0,0.1)';">
                    ...
                    <p class="h3 mb-0" style="color: #4A90E2; font-weight: 700;">Rp <?php echo e(number_format($service->price_per_hour, 0, ',', '.')); ?></p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="info-card" style="background: white; border-radius: 15px; padding: 30px; box-shadow: 0 10px 40px rgba(0,0,0,0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;" onmouseover="this.style.transform='translateY(-10px)'; this.style.boxShadow='0 15px 50px rgba(0,0,0,0.15)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 10px 40px rgba(0,0,0,0.1)';">
                    ...
                    <p class="h3 mb-0" style="color: #f5576c; font-weight: 700;">Rp <?php echo e(number_format($service->price_per_day, 0, ',', '.')); ?></p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="info-card" style="background: white; border-radius: 15px; padding: 30px; box-shadow: 0 10px 40px rgba(0,0,0,0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;" onmouseover="this.style.transform='translateY(-10px)'; this.style.boxShadow='0 15px 50px rgba(0,0,0,0.15)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 10px 40px rgba(0,0,0,0.1)';">
                    ...
                    <p class="h3 mb-0" style="color: #00f2fe; font-weight: 700; text-transform: capitalize;"><?php echo e($service->status == 'available' ? 'Tersedia' : 'Tidak Tersedia'); ?></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="feature-item d-flex align-items-start p-3" style="border-radius: 12px; transition: all 0.3s ease;" onmouseover="this.style.background='#f7fafc';" onmouseout="this.style.background='transparent';">
                                <div class="feature-icon me-3" style="width: 50px; height: 50px; background: linear-gradient(135deg, #4A90E2 0%, #357ABD 100%); border-radius: 12px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                                    <i class="fas <?php echo e($feature['icon']); ?>" style="color: white; font-size: 1.2rem;"></i>
                                </div>
                                <div>
                                    <h5 class="fw-bold mb-1" style="color: #2d3748;"><?php echo e($feature['title']); ?></h5>
                                    <p class="mb-0" style="color: #718096; font-size: 0.95rem;"><?php echo e($feature['desc']); ?></p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                <div id="booking-form" class="booking-sidebar" style="background: white; border-radius: 20px; padding: 30px; box-shadow: 0 5px 30px rgba(0,0,0,0.08); position: sticky; top: 100px;">
                    ...
                    <form id="bookingForm">
                        <input type="hidden" id="serviceName" value="<?php echo e($service->name); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="rental_date" class="form-control" required style="border-radius: 10px; padding: 12px; border: 2px solid #e2e8f0;" min="<?php echo e(date('Y-m-d', strtotime('+3 days'))); ?>">
                        </div>
                        
                        <div class="mb-3">
                            <label class="form-label fw-semibold" style="color: #4a5568;">Tanggal Kembali</label>
                            <input type="date" name="return_date" class="form-control" required style="border-radius: 10px; padding: 12px; border: 2px solid #e2e8f0;" min="<?php echo e(date('Y-m-d', strtotime('+4 days'))); ?>">
                        </div>
...
<!-- Related Services -->
<?php if($footerServices && $footerServices->count() > 0): ?>
<section class="related-services py-5" style="background: #f7fafc;">
    <div class="container">
        ...
        <div class="row g-4">
            <?php $__currentLoopData = $footerServices->where('id', '!=', $service->id)->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-4">
                <div class="service-card" style="background: white; border-radius: 15px; overflow: hidden; box-shadow: 0 5px 20px rgba(0,0,0,0.08); transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-10px)'; this.style.boxShadow='0 10px 30px rgba(0,0,0,0.15)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 5px 20px rgba(0,0,0,0.08)';">
                    <div class="card-image" style="height: 200px; background: linear-gradient(135deg, #4A90E2 0%, #357ABD 100%); display: flex; align-items: center; justify-content: center;">
                        <i class="fas fa-<?php echo e($relatedService->unit == 'orang' ? 'users' : ($relatedService->unit == 'bus' ? 'bus' : ($relatedService->unit == 'lab' ? 'laptop' : 'box'))); ?>" style="font-size: 4rem; color: white; opacity: 0.9;"></i>
                    </div>
                    <div class="card-body p-4">
                        <h5 class="fw-bold mb-2" style="color: #2d3748;"><?php echo e($relatedService->name); ?></h5>
                        <p class="text-muted mb-3" style="font-size: 0.95rem;"><?php echo e(Str::limit($relatedService->description, 80)); ?></p>
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div>
                                <small class="text-muted d-block">Mulai dari</small>
                                <strong style="color: #4A90E2; font-size: 1.2rem;">Rp <?php echo e(number_format($relatedService->price_per_hour, 0, ',', '.')); ?></strong>
                                <small class="text-muted">/jam</small>
                            </div>
                        </div>
                        <a href="<?php echo e(route('service.show', $relatedService->slug)); ?>" class="btn btn-outline-primary w-100" style="border-radius: 10px; font-weight: 600;">
                            Lihat Detail
                        </a>
                    </div>
                </div>
...
<section class="contact-cta py-5" style="background: linear-gradient(135deg, #4A90E2 0%, #357ABD 100%);">
    <div class="container text-center">
        ...
        <div class="d-flex gap-3 justify-content-center flex-wrap">
            ...
            <a href="tel:<?php echo e($contactInfo['company_phone']); ?>" class="btn btn-outline-light btn-lg px-4 py-3" style="border-radius: 50px; font-weight: 600; border-width: 2px;">
                <i class="fas fa-phone me-2"></i>Telepon
            </a>
            <a href="mailto:<?php echo e($contactInfo['company_email']); ?>" class="btn btn-outline-light btn-lg px-4 py-3" style="border-radius: 50px; font-weight: 600; border-width: 2px;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\BLUD-SMKN-1-CIAMIS\resources\views/service/show.blade.php ENDPATH**/ ?>