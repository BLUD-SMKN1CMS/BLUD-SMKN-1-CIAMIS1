                ...
                <div class="success-card" style="background: white; border-radius: 30px; padding: 60px 40px; box-shadow: 0 20px 60px rgba(0,0,0,0.3); text-align: center;">
                    ...
                    <div class="contact-support mt-5 pt-4" style="border-top: 2px solid #e2e8f0;">
                        ...
                        <div class="d-flex gap-3 justify-content-center flex-wrap">
                            ...
                            <a href="mailto:{{ $contactInfo['company_email'] ?? 'blud@smkn1ciamis.sch.id' }}" class="btn btn-secondary" style="border-radius: 50px; padding: 10px 20px;">
                                <i class="fas fa-envelope me-2"></i>{{ $contactInfo['company_email'] ?? 'blud@smkn1ciamis.sch.id' }}
                            </a>
                        </div>
                    </div>
                </div>
