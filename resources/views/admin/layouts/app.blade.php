...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a href="{{ route('admin.tefas.index') }}" class="nav-link {{ request()->is('admin/tefas*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.carousels.index') }}" class="nav-link {{ request()->is('admin/carousels*') ? 'active' : '' }}">
    ...
    <div class="main-content">
        ...
        <header class="topbar">
            <div class="topbar-left">
                ...
                <p>@yield('page-subtitle', 'Panel Admin BLUD SMKN 1 Ciamis')</p>
            </div>
