...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <option value="Makanan" <?php echo e(old('category', $product->category) == 'Makanan' ? 'selected' : ''); ?>>Makanan</option>
                                <option value="Minuman" <?php echo e(old('category', $product->category) == 'Minuman' ? 'selected' : ''); ?>>Minuman</option>
                                <option value="Jasa" <?php echo e(old('category', $product->category) == 'Jasa' ? 'selected' : ''); ?>>Jasa</option>
                                <option value="Barang" <?php echo e(old('category', $product->category) == 'Barang' ? 'selected' : ''); ?>>Barang</option>
                                <option value="Lainnya" <?php echo e(old('category', $product->category) == 'Lainnya' ? 'selected' : ''); ?>>Lainnya</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('unit', $product->unit ?? 'pcs')); ?>" required placeholder="Contoh: pcs, box, kg">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <input type="hidden" name="order" value="<?php echo e(old('order', $product->order)); ?>">
                    </div>
                    </div>
                </div>
