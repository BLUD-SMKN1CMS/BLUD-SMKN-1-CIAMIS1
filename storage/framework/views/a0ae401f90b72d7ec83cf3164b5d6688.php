...
<!-- Hero Section -->
<section class="faq-hero py-5 mb-5" style="background: linear-gradient(135deg, #1e3c72 0%, #2a5298 100%); color: white; position: relative; overflow: hidden;">
        ...
        <div class="col-lg-10">
            <div class="accordion custom-accordion" id="faqAccordion">
             ...
             <div class="text-center mt-5" data-aos="zoom-in">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="btn btn-whatsapp btn-lg px-5 py-3 rounded-pill fw-bold shadow">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\BLUD-SMKN-1-CIAMIS\resources\views/faq.blade.php ENDPATH**/ ?>