<?php $__env->startSection('title', 'Edit TEFA'); ?>

<?php $__env->startSection('content'); ?>
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit TEFA</h1>
        <a href="<?php echo e(route('admin.tefas.index')); ?>" class="btn btn-secondary">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Data TEFA: <?php echo e($tefa->name); ?></h6>
        </div>
        <div class="card-body">
            <form action="<?php echo e(route('admin.tefas.update', $tefa->id)); ?>" method="POST" id="tefaForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                value="<?php echo e(old('name', $tefa->name)); ?>" required placeholder="Contoh: Akuntansi Keuangan Lembaga">
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('code', $tefa->code)); ?>" required placeholder="Contoh: AKL">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" rows="3" 
                        placeholder="Deskripsi singkat tentang jurusan TEFA ini..."><?php echo e(old('description', $tefa->description)); ?></textarea>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="icon" class="form-control" id="iconInput"
                                    value="<?php echo e(old('icon', $tefa->icon ?? 'fas fa-school')); ?>" 
                            ...
                            <div class="mt-2" id="iconPreview">
                                <div class="border rounded p-3 text-center">
                                    <i class="<?php echo e(old('icon', $tefa->icon ?? 'fas fa-school')); ?> fa-2x mb-2 text-primary"></i>
                                    <p class="mb-0 small text-muted" id="iconName"><?php echo e(old('icon', $tefa->icon ?? 'fas fa-school')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="is_active" class="form-control">
                                <option value="1" <?php echo e($tefa->is_active ? 'selected' : ''); ?>>Aktif</option>
                                <option value="0" <?php echo e(!$tefa->is_active ? 'selected' : ''); ?>>Nonaktif</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="order" class="form-control" value="<?php echo e(old('order', $tefa->order)); ?>" min="0" max="100">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" name="services_json" id="servicesJson" 
                                value='<?php echo e(old('services_json', $tefa->services_json ?? '[]')); ?>'>
                ...
                <div class="form-group mt-4">
                    ...
                    <a href="<?php echo e(route('admin.tefas.index')); ?>" class="btn btn-secondary btn-lg">
...
$(document).ready(function() {
    ...
    try {
        const existingServices = <?php echo json_encode($tefa->services_json ? json_decode($tefa->services_json, true) : [], 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\BLUD-SMKN-1-CIAMIS\resources\views/admin/tefas/edit.blade.php ENDPATH**/ ?>