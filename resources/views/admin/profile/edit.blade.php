                ...
                <div class="card-body">
                    <form action="{{ route('admin.profile.update') }}" method="POST">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <a href="{{ route('admin.profile.changePassword') }}" class="btn btn-outline-primary">
                        ...
                        <div class="col mr-2">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-1"><strong>Terdaftar:</strong> {{ $admin->created_at->format('d F Y') }}</p>
                                </div>
                                <div class="col-md-6">
                                    <p class="mb-1"><strong>Terakhir Login:</strong> {{ $admin->last_login ? $admin->last_login->diffForHumans() : 'Belum pernah login' }}</p>
