...
<?php $__env->startSection('title', 'Pemesanan Berhasil - BLUD SMKN 1 CIAMIS'); ?>
            ...
            <div class="col-lg-8">
                ...
                <div class="success-card" style="background: white; border-radius: 30px; padding: 60px 40px; box-shadow: 0 20px 60px rgba(0,0,0,0.3); text-align: center;">
                    ...
                    <div class="transaction-info" style="background: #f7fafc; border-radius: 20px; padding: 30px; margin: 30px 0; text-align: left;">
                        ...
                        <div class="info-row mb-3 pb-3" style="border-bottom: 1px solid #e2e8f0;">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <strong style="color: #2d3748; font-size: 1.1rem;"><?php echo e($payment->transaction_id); ?></strong>
                            </div>
                        </div>
                        ...
                        <div class="info-row mb-3 pb-3" style="border-bottom: 1px solid #e2e8f0;">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <strong style="color: #2d3748;"><?php echo e($payment->rentalService->customer_name); ?></strong>
                            </div>
                        </div>
                        ...
                        <div class="info-row mb-3 pb-3" style="border-bottom: 1px solid #e2e8f0;">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <strong style="color: #2d3748;"><?php echo e($payment->rentalService->service_type); ?></strong>
                            </div>
                        </div>
                        ...
                        <div class="info-row mb-3 pb-3" style="border-bottom: 1px solid #e2e8f0;">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <strong style="color: #2d3748;"><?php echo e(\Carbon\Carbon::parse($payment->rentalService->rental_date)->format('d F Y')); ?></strong>
                            </div>
                        </div>
                        ...
                        <div class="info-row mb-3 pb-3" style="border-bottom: 1px solid #e2e8f0;">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <strong style="color: #2d3748;"><?php echo e(\Carbon\Carbon::parse($payment->rentalService->return_date)->format('d F Y')); ?></strong>
                            </div>
                        </div>
                        ...
                        <div class="info-row mb-3 pb-3" style="border-bottom: 1px solid #e2e8f0;">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <strong style="color: #2d3748; text-transform: capitalize;">
                                    <?php if($payment->payment_method == 'e-wallet'): ?>
                                        E-Wallet (<?php echo e($payment->ewallet_type); ?>)
                                    <?php else: ?>
                                        <?php echo e($payment->payment_method == 'cash' ? 'Tunai' : 'Transfer Bank'); ?>
                        ...
                        <div class="info-row">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <strong style="color: #4A90E2; font-size: 1.5rem;">Rp <?php echo e(number_format($payment->amount, 0, ',', '.')); ?></strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ewallet-info" style="background: #f0fff4; border-left: 4px solid #48bb78; border-radius: 12px; padding: 20px; margin: 30px 0; text-align: left;">
                        ...
                        <div class="mb-2">
                            <strong style="color: #2d3748;"><?php echo e($payment->ewallet_type); ?></strong><br>
                    ...
                    <div class="action-buttons mt-4 d-flex gap-3 justify-content-center flex-wrap">
                        <a href="<?php echo e(route('home')); ?>" class="btn btn-outline-primary btn-lg px-5 py-3" style="border-radius: 50px; font-weight: 600; border-width: 2px;">
                            <i class="fas fa-home me-2"></i>Kembali ke Beranda
                        </a>
                        <a href="<?php echo e(route('services.all')); ?>" class="btn btn-primary btn-lg px-5 py-3" style="background: linear-gradient(135deg, #4A90E2 0%, #357ABD 100%); border: none; border-radius: 50px; font-weight: 600; box-shadow: 0 4px 15px rgba(102, 126, 234, 0.4);">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\BLUD-SMKN-1-CIAMIS\resources\views/booking/success.blade.php ENDPATH**/ ?>