    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route($routePrefix . '.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="tefa_id" value="{{ old('tefa_id', $product->tefa_id) }}">
                ...
                <input type="hidden" name="unit" value="{{ old('unit', $product->unit ?? 'layanan') }}">
                <input type="hidden" name="order" value="{{ old('order', $product->order) }}">
