...
@section('content')
<!-- Hero Section -->
<section class="about-hero py-5 mb-5" style="background: linear-gradient(135deg, #1e3c72 0%, #2a5298 100%); color: white; position: relative; overflow: hidden;">
...
<div class="container mb-5">
    <div class="row align-items-center mb-5">
        <div class="col-lg-6 mb-4 mb-lg-0" data-aos="fade-right">
            <img src="{{ asset('assets/iconsmea.png') }}" alt="BLUD SMKN 1 Ciamis" class="img-fluid rounded-3 shadow-lg" style="max-height: 400px; width: 100%; object-fit: contain; background: #f8f9fa; padding: 20px;">
        </div>
    ...
    <div class="bg-light rounded-3 p-5 mb-5" data-aos="fade-up">
        <div class="row text-center">
            <div class="col-md-3 mb-4 mb-md-0">
                <h2 class="fw-bold text-primary display-4">{{ $stats['total_tefas'] ?? 7 }}</h2>
            ...
            <div class="col-md-3">
                <h2 class="fw-bold text-primary display-4">{{ $stats['years_exp'] ?? 10 }}+</h2>
